...
use Wirement\Profile\Pages\Dashboard;
use Filament\Panel;
...
class AppPanelProvider extends PanelProvider
{
    ...
    {
        // \Illuminate\Support\Facades\Gate::policy(\Wirement\Profile\Models\Team::class, \Wirement\Profile\Policies\TeamPolicy::class);
    }
}
