...
namespace Wirement\Profile\Livewire;
...
abstract class BaseLivewireComponent extends Component implements HasActions, HasForms
{
    ...
    {
        Notification::make()
            ->title(__('wirement-profile::default.notification.rate_limited.title'))
            ->body(__('wirement-profile::default.notification.rate_limited.message', ['seconds' => $exception->secondsUntilAvailable]))
            ->danger()
            ->send();
    }
