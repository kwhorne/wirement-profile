...
class Agent extends MobileDetect
{
    ...
    {
        return $this->retrieveUsingCacheOrResolve('wirement-profile.platform', function () {
    ...
    {
        return $this->retrieveUsingCacheOrResolve('wirement-profile.browser', function () {
            return $this->findDetectionRulesAgainstUserAgent(
    ...
    {
        return $this->retrieveUsingCacheOrResolve('wirement-profile.desktop', function () {
