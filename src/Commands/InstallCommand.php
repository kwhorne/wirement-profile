...
{
    public $signature = 'wirement-profile:install {--teams : Indicates if team support should be installed}
                                              {--api : Indicates if API support should be installed}';

    public $description = 'Install the Laravel wirement-profile and Filament Panel components.';
    ...
    public function handle(): int
    {
        ...
        if ($this->option('teams')) {
            $this->call('vendor:publish', ['--tag' => 'wirement-profile-team-migrations', '--force' => true]);
            ...
            // Add \Wirement\Profile\HasTeams trait to User Model
            $this->replaceInFile(
                '// use Wirement\Profile\HasTeams',
                'use Wirement\Profile\HasTeams',
                app_path('Models/User.php')
            );
        ...
        // Publish wirement-profile migrations
        $this->call('vendor:publish', ['--tag' => 'wirement-profile-migrations']);
        ...
        $this->info('DONE: Filament wirement-profile starter kit installed successfully.');
